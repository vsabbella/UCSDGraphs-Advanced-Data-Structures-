...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(Integer i =0; i<getNumVertices(); i++){
            List<Integer> outNeigbours = new ArrayList<Integer>();
			List<Integer> inNeigbours = new ArrayList<Integer>();
			inNeigbours.addAll(getInNeighbors(i));
			outNeigbours.addAll(getNeighbors(i));
			//System.out.println("IN"+inNeigbours+"OUT"+inNeigbours);
			//System.out.println("OUT"+inNeigbours);
			Integer degreeForVertex_i=inNeigbours.size()+outNeigbours.size();
			/*for (Integer eachNeighbour:neigbours
				 ) {
				degreeForVertex_i += eachNeighbour;
			}*/
			degreeSequence.add(degreeForVertex_i);
